...
Repo: `Expri-commits/omarchy-anki-theme`. The project was planned and decided on
an internal wayfinder map (decision log not published). Performance measurements
live in [`docs/performance.md`](docs/performance.md); architecture decisions in
[`docs/adr/`](docs/adr/); the verification gate — what "full surface" is held
to, and how — in [`docs/verification.md`](docs/verification.md).
